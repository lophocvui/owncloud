...
// Show warning if PHP 8 is used as ownCloud is not compatible with PHP 8
if (\version_compare(PHP_VERSION, '8.0.0alpha1') !== -1) {
	echo 'This version of ownCloud is not compatible with PHP 8' . PHP_EOL;
